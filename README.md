...
1. Clone this repository:
   ```bash
   git clone https://github.com/rukeshbabugantla143/3D-portfolio.git
   ```
...
- **Email:** rukeshbabug@gmail.com
- **LinkedIn:** [Your LinkedIn Profile](https://www.linkedin.com/in/rukeshbabugantla/)
